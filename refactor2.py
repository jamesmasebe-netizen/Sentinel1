...
# 1. Timeline Tab
timeline_imports = common_imports + "import '../../widgets/custom_gantt_chart.dart';\n\n"
...
overview_class = """class OverviewTab extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
""" + get_lines(342, 553) + "\n" + get_lines(555, 597) + "\n" + get_lines(599, 613) + "\n" + get_lines(1572, 1681).replace("_showEditProjectDetailsDialog(BuildContext context, Project project)", "showEditProjectDetailsDialog(BuildContext context, Project project, WidgetRef ref)") + "\n" + get_lines(1683, 1744).replace("_showEditDescriptionDialog(BuildContext context, Project project)", "showEditDescriptionDialog(BuildContext context, Project project, WidgetRef ref)") + "\n" + get_lines(1746, 1874).replace("_showEditContactsDialog(BuildContext context, Project project)", "showEditContactsDialog(BuildContext context, Project project, WidgetRef ref)") + "\n}\n"
...
workflow_class = """class WorkflowTab extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
""" + get_lines(616, 681) + "\n" + get_lines(683, 731).replace("_showApprovalDialog(BuildContext context, Project project, ProjectStage stage)", "_showApprovalDialog(BuildContext context, Project project, ProjectStage stage, WidgetRef ref)") + "\n" + get_lines(733, 754).replace("_handleStageApproval(BuildContext context, Project project, ProjectStage stage, String approverId)", "_handleStageApproval(BuildContext context, Project project, ProjectStage stage, String approverId, WidgetRef ref)") + "\n}\n"
...
contractors_class = """class ContractorsTab extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
""" + get_lines(1085, 1317) + "\n" + get_lines(1319, 1341) + "\n" + get_lines(1343, 1345) + "\n" + get_lines(1347, 1397) + "\n" + get_lines(1500, 1570).replace("_showAssignContractorDialog(BuildContext context, Project project)", "showAssignContractorDialog(BuildContext context, Project project, WidgetRef ref)") + "\n}\n\n" + get_lines(1879, 2067)
