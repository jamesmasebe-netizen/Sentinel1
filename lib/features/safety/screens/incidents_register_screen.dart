...
class IncidentsRegisterScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<IncidentsRegisterScreen> createState() =>
      _IncidentsRegisterScreenState();
}

class _IncidentsRegisterScreenState
    extends ConsumerState<IncidentsRegisterScreen> {
                      ...
                      : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return IncidentCard(
                            ...
                            onStatusUpdate: (s) => _updateStatus(doc.id, s),
                          );
                        },
                      ),
            ),
