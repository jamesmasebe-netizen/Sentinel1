...
class SkillMatrixCard extends StatelessWidget {
  ...
  const SkillMatrixCard({super.key, required this.employeeName, required this.skills});
  ...
  IconData _profIcon(String p) {
    switch (p) {
      ...
      case 'Intermediate': return Icons.horizontal_rule;
              ...
              return Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      skill['skill'] ?? '',
                      style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: _profColor(prof)),
                    ),
                    GSpacing.hSm,
                    Text(
                      '($prof)',
                      style: TextStyle(fontSize: 9, color: _profColor(prof).withValues(alpha: 0.7)),
                    ),
                  ],
                ),
              );
