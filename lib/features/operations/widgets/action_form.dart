...
import '../services/action_tracker_service.dart';
...
class _ActionFormState extends ConsumerState<ActionForm> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final assigneeEmp = employeesList.firstWhere(
        (e) => e.id == _selectedEmployeeId,
        orElse: () => throw Exception('Assignee not found'),
      );

      final item = ActionItem(
        id: '', // Will be generated by Firestore if left empty, or we can use a timestamp
        ...
        assignee: assigneeEmp.fullName,
      );

      await ref.read(actionTrackerServiceProvider).createActionItem(item);
