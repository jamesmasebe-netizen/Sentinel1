            ...
            content: Form(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: ['Materials', 'Labour', 'Equipment', 'Subcontractor', 'Other']
                      ...
                      if (formKey.currentState!.validate()) {
                        ...
                        try {
                          ...
                          final expense = ProjectExpense(
                            ...
                            loggedBy: ref.read(userProfileProvider).valueOrNull?.uid,
                          );
                          await ref.read(projectServiceProvider).addExpense(expense);
                          if (ctx.mounted) {
                            Navigator.pop(ctx);
                            UIUtils.showToast(context, 'Expense added successfully.', type: ToastType.success);
                          }
                        } catch (e) {
                          if (ctx.mounted) {
                            UIUtils.showToast(context, 'Failed to save expense: $e', type: ToastType.error);
                          }
                        } finally {
                          if (ctx.mounted) {
