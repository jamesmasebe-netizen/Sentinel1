              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      '\$${project.actualSpend.toStringAsFixed(2)}',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 18,
                        color: cpi < 1.0 ? XMTheme.error : XMTheme.primary,
                      ),
                    ),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      '\$${(project.budget - project.actualSpend).toStringAsFixed(2)}',
                      style: const TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                      ),
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (ctx, i) {
                      ...
                      return ListTile(
                        ...
                        subtitle: Text(
                          '${exp.category} • ${exp.loggedAt.toLocal().toString().split(' ')[0]}',
                        ),
                        trailing: Row(
