...
import '../../safety/screens/contractor_qr_passport_screen.dart';
...
class ContractorProjectsSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ContractorProjectsSheet> createState() =>
      _ContractorProjectsSheetState();
}

class _ContractorProjectsSheetState
    extends ConsumerState<ContractorProjectsSheet> {
  Future<List<Map<String, dynamic>>> _fetchProjectsForContractor(
    String contractorId,
  ) async {
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: () {
                          UIUtils.showSideSheet(
                            context: context,
                            title: 'Safety Passport: ${widget.contractorName}',
                            builder:
                                (ctx) => ContractorQrPassportScreen(
                                  contractorData: {
                                    'id': widget.contractorId,
                                    'companyName': widget.contractorName,
                                  },
                                ),
                          );
                        },
                        icon: const Icon(Icons.qr_code, color: XMTheme.primary),
                        tooltip: 'Generate Passport',
                      ),
                      IconButton(
                          ...
                          Expanded(
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final project =
                                    entry['project'] as Map<String, dynamic>;
                                ...
                                final progress =
                                    (project['overallProgress'] as num?)
                                        ?.toDouble() ??
                                    0.0;
                                ...
                                if (submission != null) {
                                  ...
                                  ohsScore =
                                      (submission['score'] as num?)
                                          ?.toDouble() ??
                                      0.0;
                                  switch (rawStatus) {
                                    case 'finalized':
                                      ohsStatus = 'OHS Approved';
                                      ...
                                      if (submission != null) ...[
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                              'OHS Score: ${ohsScore.toStringAsFixed(0)}%',
                                              style: TextStyle(
                                                fontSize: 11,
                                                color: ohsColor,
                                                fontWeight: FontWeight.w600,
