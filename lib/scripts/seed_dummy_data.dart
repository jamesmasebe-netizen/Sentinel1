...
Future<void> seedAllDummyData(FirebaseFirestore firestore) async {
  ...
  final incidents = <Map<String, dynamic>>[
    ...
    {
      'title': 'Scaffolding collapse on South Wing',
    ...
    {
      'title': 'Unauthorized entry into HV zone',
      'type': 'Near Miss',
      'severity': 'Major',
    ...
    {
      'title': 'Worker slipped on wet floor in canteen',
      'type': 'Injury',
      'severity': 'Moderate',
      'status': 'Resolved',
      'description':
    ...
    {
      'title': 'Hand laceration during drywall install',
      'type': 'Injury',
      'severity': 'Minor',
      'status': 'Closed',
      'description':
    ...
    {
      'title': 'Diesel spill near stormwater drain',
      'type': 'Environmental',
      'severity': 'Major',
      'status': 'Open',
      'description':
    ...
    {
      'title': 'Loose railing on stairwell B',
    ...
    {
      'title': 'Near miss: Crane load swung over workers',
      'type': 'Near Miss',
      'severity': 'Critical',
      'status': 'Investigating',
      'description':
    ...
    {
      'title': 'Vehicle collision in parking lot',
      'type': 'Property Damage',
      'severity': 'Minor',
      'status': 'Closed',
      'description':
  ...
  final hazards = <Map<String, dynamic>>[
    {
      'title': 'Unguarded floor opening on Level 4',
      'description': 'Floor opening for HVAC ducting left unguarded overnight',
      'severity': 'Critical',
    ...
    {
      'title': 'Exposed electrical wiring in corridor',
      'description': 'Wiring exposed from ongoing rewiring project',
      'severity': 'High',
    ...
    {
      'title': 'Poor lighting in basement parking',
      'description': '3 of 8 LED panels not working in basement parking P2',
      'severity': 'Medium',
    ...
    {
      'title': 'Minor trip hazard from cable tray',
      'description': 'Temporary cable tray across walkway near server room',
      'severity': 'Low',
  ...
  final waste = <Map<String, dynamic>>[
    {
      'type': 'Hazardous',
      'description': 'Paint thinner and solvent drums',
      'quantity': '500kg',
    ...
    {
      'type': 'General',
      'description': 'Demolition rubble and concrete',
      'quantity': '2 Tons',
    ...
    {
      'type': 'Recyclable',
      'description': 'Scrap metal and copper wiring',
      'quantity': '1.5 Tons',
  ...
  final esg = <Map<String, dynamic>>[
    ...
    {
      'metric': 'Community Investment Hours',
      'value': '120 hrs',
      'target': '100 hrs',
      'status': 'Achieved',
      'siteId': siteA,
  ...
  final dra = <Map<String, dynamic>>[
    {
      'task': 'Roofing Retrofit — Fall Risk',
      'riskLevel': 'Extreme',
    ...
    {
      'task': 'Painting Admin Block Interior',
      'riskLevel': 'Low',
    ...
    {
      'task': 'Trench Digging for Water Main',
      'riskLevel': 'High',
  ...
  final hira = <Map<String, dynamic>>[
    {
      ...
      'hazard': 'Collapse due to improper bracing or corroded components',
      'consequence': 'Fatality or multiple serious injuries',
      'likelihood': 'Possible',
    ...
    },
    {
      ...
      'hazard':
          'Back injury from lifting concrete blocks without mechanical aids',
      'consequence': 'Chronic musculoskeletal injury',
      'likelihood': 'Likely',
      'severity': 'Moderate',
      'riskScore': 12,
      'riskLevel': 'High',
    ...
    {
      'title': 'Electrical Work on Live Systems',
      'hazard': 'Electrocution from contact with live conductors',
    ...
    {
      'title': 'Office Ergonomics — Admin Block',
      'hazard': 'RSI from prolonged computer work',
      'consequence': 'Wrist pain, carpal tunnel',
      'likelihood': 'Possible',
      'severity': 'Minor',
      'riskScore': 6,
      'riskLevel': 'Medium',
    ...
    {
      'title': 'Vehicle Movement in Laydown Area',
      'hazard': 'Pedestrian struck by reversing truck',
  ...
  final bowties = <Map<String, dynamic>>[
    {
      'title': 'Scaffolding Collapse Scenario',
      'topEvent': 'Structural Collapse',
      'threats': 'Corroded base plates, overloading, wind',
      'consequences': 'Fatalities, project delay, legal action',
      'preventiveBarriers': 'Load calculations, inspections, wind meters',
    ...
    },
    {
      ...
      'topEvent': 'Fire / Explosion',
      'threats': 'Sparks near flammables, no fire watch',
      'consequences': 'Building fire, injuries, asset loss',
      'preventiveBarriers': 'Hot work permit, fire watch, area clearance',
    ...
    {
      'title': 'Confined Space Entry — Basement',
      'topEvent': 'Confined Space Emergency',
      'threats': 'O2 depletion, toxic gas, engulfment',
      'consequences': 'Asphyxiation, rescue failure',
      'preventiveBarriers': 'Gas testing, ventilation, entry permit',
  ...
  final strategicRisks = <Map<String, dynamic>>[
    {
      'title': 'Regulatory Non-Compliance — OHS Act',
      'description':
          'Risk of enforcement action due to incomplete section 16.2 appointments',
      'category': 'Regulatory',
      'owner': 'Alice Smith',
      'likelihood': 'Possible',
      'impact': 'Severe',
    ...
    {
      'title': 'Contractor Insolvency — SafeScaffold Co',
      'description':
          'Key scaffolding contractor facing financial difficulties, may default on project',
      'category': 'Financial',
      'owner': 'David Lee',
      'likelihood': 'Likely',
      'impact': 'Significant',
    ...
    },
    {
      ...
      'description':
          'Potential media coverage if scaffolding collapse results in fatality',
    ...
    {
      'title': 'Climate Event Disruption',
      'description':
          'Severe weather could halt construction for extended periods',
  ...
  final propertyProjects = <Map<String, dynamic>>[
    {
      ...
      'description':
          'Quarterly servicing and filter replacement for central HVAC units.',
      'status': 'Ongoing',
    ...
    },
    {
      ...
      'description':
          'Replacing all T5 tubes with energy-efficient LED panels across floors 1-6.',
      'status': 'Planned',
    ...
    },
    {
      ...
      'description':
          'Sealing joints and replacing damaged sheets in the northwest corner.',
      'status': 'Completed',
      'assignedTo': 'Acme Builders',
      'dueDate': iso(2),
      'progress': 100,
  ...
  final leases = <Map<String, dynamic>>[
    ...
    {
      'propertyId': 'PROP-002',
      'tenantName': 'Industrial Supplies Ltd',
      'leaseStart': iso(200),
      'leaseEnd': iso(10),
      'monthlyRent': 85000,
      'status': 'Expiring Soon',
  ...
  final assets = <Map<String, dynamic>>[
    {
      'propertyId': 'PROP-001',
      'assetName': 'Primary Elevator Bank A',
    ...
    {
      'propertyId': 'PROP-001',
      'assetName': 'Central Cooling Plant',
      'category': 'HVAC',
      'condition': 'Fair',
    ...
    {
      'propertyId': 'PROP-002',
      'assetName': 'Industrial Racking System',
      'category': 'Equipment',
      'condition': 'Excellent',
